  ...
  return (
    <div className="max-sm:mt-[430px]  ">
      <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between">
        ...
        <div className=" max-sm:my-4 gap-4 flex items-center justify-center" data-aos="fade-left">
            ...
            <div className="grid  grid-cols-3 gap-4  max-sm:grid-cols-1">
              <div className="relative overflow-hidden rounded-lg shadow-sm ">
                <img
                  ...
                  alt="Card Image"
                  className="w-full  rounded-xl h-[280px] transition-transform duration-300 hover:scale-105 cursor-pointer  "
                />
                ...
                <div>
                  ...
                  <button className=" my-4 py-2 px-4 bg-[#c1285d] hover:bg-opacity-80  text-white rounded-xl " >CONOCER MAS</button>
                </div>
              </div>
              <div className=" relative overflow-hidden">
                <img src="https://agora2030.org/wp-content/uploads/2024/03/Francis-Castillo-768x602.webp" alt="content" className=" rounded-xl h-[280px]   transition-transform duration-300 hover:scale-105 cursor-pointer" />
                ...
                <div>
                  <h1 className=" line-clamp-2 text-gray-700 my-3 font-bold">“Alcanzar un equilibrio entre el trabajo y familia uno de los retos más importantes al ser empresaria”</h1>
                  <p className=" line-clamp-3 text-gray-500">Francis Castillo, fundadora de ‘The Baking Mom’es un gran ejemplo de cómo el ser mamá y emprendedora </p>
                  <button className=" my-4 py-2 px-4 bg-[#c1285d] hover:bg-opacity-80  text-white rounded-xl ">CONOCER MAS</button>
                </div>
              </div>
              <div className=" overflow-hidden relative">
                <img src="https://agora2030.org/wp-content/uploads/2024/03/Agora-Partnership-y-Change-Lab-jpg.webp" alt="content" className=" rounded-xl h-[285px] transition-transform duration-300 hover:scale-105 cursor-pointer" />
                <div className=" absolute top-4 left-2">
                ...
                <div>
                  ...
                  <p className=" text-gray-500">Esta unión no solo representa una evolución en el nombre de la marca colombiana a ChangeLab, sino que también establece ambiciosas metas.</p>
                  <button className=" my-4 py-2 px-4 bg-[#c1285d] hover:bg-opacity-80  text-white rounded-xl">CONOCER MAS</button>
                </div>
              </div>
            </div>
