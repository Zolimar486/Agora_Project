        ...
        <div className=" flex flex-col gap-8">
          ...
          <div className="grid  grid-cols-3 gap-4  max-sm:grid-cols-1">
            <div className="relative">
              <img src="https://agora2030.org/wp-content/uploads/2024/02/Disenador-freelance-1024x716.webp" alt="content" className=" rounded-xl h-[285px] transition-transform duration-300 hover:scale-105 cursor-pointer " />
              ...
              <div className=" my-10">
                ...
                <button className=" bg-[#c1285d] hover:bg-opacity-80  my-4 py-2 px-4  text-white rounded-xl">CONOCER MAS</button>
              </div>
            </div>
            <div className=" relative">
              <img src="https://agora2030.org/wp-content/uploads/2024/02/Data-engineer-1024x684.webp" alt="content" className=" rounded-xl h-[280px] transition-transform duration-300 hover:scale-105 cursor-pointer" />
            ...
            <div className="relative">
              <img src="https://agora2030.org/wp-content/uploads/2024/02/Gerente-de-Alianzas-1024x684.webp" alt="content" className=" rounded-xl h-[285px] transition-transform duration-300 hover:scale-105" />
              <div className=" absolute top-4 left-2 ">
                <button className=" text-[10px] py-2 px-4 bg-slate-800 text-white rounded-xl">OPORTUNIDAD LABORAL</button>
              </div>
              <div className=" my-10">
                ...
                <button className=" my-4 py-2 px-4 bg-[#c1285d] hover:bg-opacity-80 text-white rounded-xl hover:  ">CONOCER MAS</button>
              </div>
            </div>
          </div>
        </div>
